...
public class NotesContract {
    ...
    public static final String DB_NAME = "AndroidNotes.db";
    public static final int DB_VERSION = 2;

    public static final String AUTHORITY = "com.example.mvdmvn.notes.provider";
    ...
    public static abstract class Notes implements BaseColumns {
        ...
        // Список заметок
        public static final String URI_TYPE_NOTE_DIR = "vnd.android.cursor.dir/vnd.mvdmvn.notes";

        // Одна заметка
        public static final String URI_TYPE_NOTE_ITEM = "vnd.android.cursor.item/vnd.mvdmvn.notes";
    ...
    public static abstract class Images implements BaseColumns {
         ...
         * Типы данных
         */
        public static final String URI_TYPE_IMAGE_DIR = "vnd.android.cursor.dir/vnd.mvdmvn.image";
        public static final String URI_TYPE_IMAGE_ITEM = "vnd.android.cursor.item/vnd.mvdmvn.image";
    }
